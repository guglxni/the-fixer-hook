...
/// @notice Live testnet deployment: Registry + Proxy + HookV2 + Credential
/// @dev Uses real Base Sepolia USDC and WETH — no mocks
///
/// Environment Variables:
///   PRIVATE_KEY              - Deployer private key (must have Base Sepolia ETH)
...
contract DeployBaseSepolia is Script {
    // ====================================================================
    // BASE SEPOLIA CONSTANTS (live testnet addresses)
    // ====================================================================

    address constant POOL_MANAGER = 0x05E73354cFDd6745C338b50BcFDfA3Aa6fA03408;
    address constant USDC = 0x036CbD53842c5426634e7929541eC2318f3dCF7e;
    address constant WETH = 0x4200000000000000000000000000000000000006;
    uint256 constant QUOTE_TOKEN_INDEX = 0; // USDC is currency0
    ...
    function run() external {
        ...
        console.log("=== FixerHook Protocol - Base Sepolia Live Deployment ===");
